...
public class Model {
	...
	public List <Adiacenza> getArchi(){
		//calcolo prima il peso medio degli archi presenti nel grafo e successivamente
	...
	private void cerca(String destinazione, List <String> parziale) {
		...
		//caso terminale
		if(parziale.get(parziale.size()-1).equals(destinazione)) { //con questa get
										//prendo ultimo elemento inserito in parziale
		
			if(parziale.size()> this.percorsoMigliore.size()) { //se la mia parziale
											//è migliore della soluzione migliore che
										//avevo visto fino a quel momento la sovrascrivo
		...
		//...altrimenti scorro i vicini dell'ultimo inserito e provo ad aggungerli uno ad uno
